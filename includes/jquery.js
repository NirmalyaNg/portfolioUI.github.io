...
!(function (e, t) {
	...
	var p = (function (n) {
					...
					(x.find.TAG = p.getElementsByTagName
						? function (e, t) {
								return 'undefined' != typeof t.getElementsByTagName
									...
									: p.qsa ? t.querySelectorAll(e) : void 0;
							}
						: function (e, t) {
								var n,
									r = [],
								...
								return (
									...
									(!p.sortDetached && t.compareDocumentPosition(e) === n)
										? e == T || (e.ownerDocument == d && y(d, e))
											? -1
											: t == T || (t.ownerDocument == d && y(d, t)) ? 1 : u ? H(u, e) - H(u, t) : 0
										: 4 & n ? -1 : 1)
								);
							}
						: function (e, t) {
		...
		(se.attr = function (e, t) {
			...
			return void 0 !== r
				? r
				: p.attributes || !E ? e.getAttribute(t) : (r = e.getAttributeNode(t)) && r.specified ? r.value : null;
		}),
	...
	((E.fn.init = function (e, t, n) {
		...
		return e.nodeType
			...
			: b(e) ? (void 0 !== n.ready ? n.ready(e) : e(E)) : E.makeArray(e, this);
	}).prototype =
		E.fn),
		(L = E(w));
	...
	E.fn.extend({
		...
		index: function (e) {
			return e
				? 'string' == typeof e ? i.call(E(e), this[0]) : i.call(this, e.jquery ? e[0] : e)
	...
	function B (e, t, n, r) {
		...
		try {
			e && b((i = e.promise))
				...
				: e && b((i = e.then)) ? i.call(e, t, n) : t.apply(void 0, [ e ].slice(r));
		} catch (e) {
			n.apply(void 0, [ e ]);
		}
	}
			...
			return arguments.length
				...
				: t
					? (r = E.valHooks[t.type] || E.valHooks[t.nodeName.toLowerCase()]) &&
						...
						? e
						: 'string' == typeof (e = t.value) ? e.replace(ut, '') : null == e ? '' : e
					: void 0;
		}
	}),
		E.extend({
	...
	(E.param = function (e, t) {
		...
		(m.createHTMLDocument = (((ft = w.implementation.createHTMLDocument('').body).innerHTML =
			'<form></form><form></form>'),
